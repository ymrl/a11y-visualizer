...
describe("analyzeTable", () => {
  ...
  test("rowGroups", () => {
    ...
    table.innerHTML = `
    <thead>
      <tr><th id="h0">0</th><th>1</th><th>2</th></tr>
    </thead>
    <tbody>
      <tr><th scope="rowgroup">0</td><td>1</td><td>2</td></tr>
      <tr><th>0</td><th scope="row">1</th><td>2</td></tr>
    ...
    <tfoot>
      <tr><th id="f0">0</th><td>1</td><td>2</td></tr>
      <tr><td>0</td><td>1</td><td headers="h0 f0">2</td></tr>
    </tfoot>
    `;
    document.body.appendChild(table);
    const result = analyzeTable(table);
    ...
    expect(result.cells[1][1].headers).toContain(result.cells[0][1].element);
    expect(result.cells[1][1].headers).toContain(result.cells[1][0].element);
    expect(result.cells[1][1].headers).toHaveLength(2);
    expect(result.cells[2][0].headers).toContain(result.cells[0][0].element);
    expect(result.cells[2][0].headers).toContain(result.cells[1][0].element);
    expect(result.cells[2][0].headers).toHaveLength(2);
    expect(result.cells[2][2].headers).toContain(result.cells[0][2].element);
    expect(result.cells[2][2].headers).toContain(result.cells[1][0].element);
    expect(result.cells[2][2].headers).toContain(result.cells[2][1].element);
    expect(result.cells[2][2].headers).toHaveLength(3);

    expect(result.cells[6][2].headers).toContain(result.cells[0][0].element);
    expect(result.cells[6][2].headers).toContain(result.cells[0][2].element);
    expect(result.cells[6][2].headers).toContain(result.cells[5][0].element);
    expect(result.cells[6][2].headers).toHaveLength(3);
  });
  ...
  test("colGroups", () => {
    ...
    expect(result.cells[1][0].headers).toContain(result.cells[0][0].element);
    expect(result.cells[1][0].headers).toHaveLength(1);
    expect(result.cells[1][1].headers).toContain(result.cells[0][1].element);
    expect(result.cells[1][1].headers).toContain(result.cells[0][2].element);
    expect(result.cells[1][1].headers).toHaveLength(2);
    expect(result.cells[1][2].headers).toContain(result.cells[0][2].element);
    expect(result.cells[1][2].headers).toHaveLength(1);
    expect(result.cells[1][3].headers).toContain(result.cells[0][2].element);
    expect(result.cells[1][3].headers).toHaveLength(1);
    expect(result.cells[1][4].headers).toContain(result.cells[0][4].element);
    expect(result.cells[1][4].headers).toHaveLength(1);
    expect(result.cells[1][5].headers).toContain(result.cells[0][4].element);
    expect(result.cells[1][5].headers).toHaveLength(1);
  });
});
